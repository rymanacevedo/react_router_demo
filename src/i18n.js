...
const resources = {
	en: {
		translation: {
			...
			accountLockedResetPassword:
				'Your account is locked. Please reset your password by clicking "Forgot password".',
			...
			forgotUsernameEmailFailed:
				'We could not send an email to this email address.  Please check your email address and try again or contact support for assistance. (Error Code: {0})',
			...
			passwordMustContain:
				'Password must contain at least 3 of the following: uppercase letters (a-z), lowercase letters (A-Z), digit (0-9), special character (!@#$% etc.)',
			lowerCaseRule: 'Lowercase letter (a-z)',
			digitRule: 'Digit (0-9)',
			specialCharacterRule: 'Special character (!@#$% etc.) ',
			multiFactorAuthEmailSentMsg:
				'You will receive a verification code at {{email}}.',
			multiFactorAuthCodeInvalidError:
				'Your passcode is incorrect or has expired, please check the code or obtain a new one and try again.',
			multiFactorAuthCheckEmailMsg:
				'To login, please check your email and enter the code below:',
			multiFactorAuthRememberDevice: 'Remember this device for 90 days',
			multiFactorAuthTimeoutMsg:
				'This code will be valid for {{duration}} minutes.',
			cookiesMessage:
				'This website uses cookies and third party services. Review our',
			privacyPolicy: 'Privacy Policy',
			termsAndConditions: 'Terms and Conditions',
			passwordsDoNotMatch: 'Passwords do not match',
			passwordRequirements:
				'Password must be at least {{charactersNumber}} characters long, and contain at least {{numberOfCriteria}} of the following:',
			...
			weWillSendPasswordResetEmail:
				'We will send you an email with instructions on how to reset your password.',
			passwordResetError:
				'We could not send an email for this username. Please check your username and try again or contact support for assistance.',
			pleaseCompleteRecaptcha: 'Please complete the reCAPTCHA.',
			pleaseCloseWindow:
				'Please close this window and follow the instructions in the email.',
			weWillSendEmail: 'We will send you an email with your username.',
			please: 'Please',
			clickHere: 'click here',
			toLogIn: 'to log in.',
			emailLabel: 'Email',
			forgotUsernameErrorText:
				'We could not send an email to this email address. Please check your email address and try again or contact support for assistance.',
			accountUrlErrorText:
				'Account not recognized. Please check the account name in the URL.',
			passcode: 'Passcode',
			pleaseEnterPasscode: 'Please enter your passcode.',
			usernameUnavailable:
				'This username is already in use. Please try another.',
			selfRegisterNotAllowed:
				'You are not allowed to self register for this account.',
			userAlreadyExistsClickBelowToLogin:
				'A user with this email address already exists. Please click below to log in.',
			passwordFormatRuleText:
				'Your password must contain 3 or more character types.',
			/////////////////////////////////////////////
			...
			fiveSureIncorrectAnswers:
				"You've been sure but incorrect five times in a row. That's OK, you're here to learn. Answer accordingly if you're not sure about an answer.",
			sixDontKnowInRound:
				"It's ok that you don't know this yet.  Make sure to read the question, answers, and explanation to learn what you don't know.",
			...
			fiveFastReviews:
				'Slow down and absorb the material.  It will take you less time to actually learn.',
			tenLongReviews:
				'You’re putting the time into reading the explanations. Good work. Its worth it.',
			twoNpaInRound:
				"Not getting it? Don't be discouraged, what you need to know is in the explanation.",
			twoIdenticalSureIncorrects:
				"That's the same thing you said last time, but it still isn't right. Make sure to read the explanation in a couple minutes!",
			twoNpaOnLu:
				"You've been struggling with that concept, make sure to pay attention next time.",
			//////////////////////////////////
			//    ProgressMenu.jsx
			//////////////////////////////////
			mastered: 'Mastered',
			...
			appErrorText:
				'Looks like you hit a snag in our system. Please wait a minute or two and try again.',
			...
			refresher: 'Refresher',
			review: 'Review',
			smartRefresher: 'Smart Refresher',
			noCoursesAssigned:
				'You are not currently assigned to a course. Please check with your administrator.',
			...
			step1ModalContent:
				'Our goal is to provide you with a focused, efficient path to mastering and retaining the information you need to be successful. The adaptive system you are using was developed based on scientific studies of how people can learn most efficiently. Click through the tour to get to know how Amplifire works.',
			step2PopoverTitle: 'We first ask questions 🤔',
			step2PopoverContent:
				'By first answering questions, we prime your brain to acquire new knowledge, creating a mental framework for the material to be learned.',
			step3PopoverTitle: 'Your estimated time left ⏰',
			step3PopoverContent:
				'This is approximately how much time we think it will take you to complete this module. It will fluctuate throughout based on how you answer.',
			step4PopoverTitle: 'Your Progress 📊',
			step4PopoverContent:
				'Amplifire comes at you in rounds. A micro testing burst followed by a learning burst. These icons indicate how you are doing in your current round. You can also use the blue bar to see your overall progress in this module',
			step5PopoverTitle: 'Your detailed progress 📊',
			step5PopoverContent:
				"You can see your detailed progress that includes feedback, your road to mastery, and how long you've spent in this session of learning.",
			step6PopoverTitle: 'Feedback 👋',
			step6PopoverContent:
				'Amplifire will help remind, encourage, and celebrate success with you as you learn',
	...
	fr: {
		translation: {
			...
			accountLockedResetPassword:
				'Ton compte est bloqué. Veuillez réinitialiser votre mot de passe en cliquant sur "Mot de passe oublié".',
			userPassIncorrect:
	...
	de: {
		translation: {
			...
			accountLockedResetPassword:
				'Ihr Konto ist gesperrt. Bitte setzen Sie Ihr Passwort zurück, indem Sie auf "Passwort vergessen" klicken.',
	...
	it: {
		translation: {
			...
			accountLockedResetPassword:
				'Il tuo account è bloccato. Reimposta la password facendo clic su "password dimenticata".',
	...
	es: {
		translation: {
			...
			typicallyEmail:
				'normalmente su direcci\u00f3n de correo electr\u00f3nico',
			password: 'contrase\u00f1a',
			...
			accountLockedResetPassword:
				'Tu cuenta esta bloqueada. Restablezca su contraseña haciendo clic en "Olvidé mi contraseña".',
			userPassIncorrect:
	...
	pt: {
		translation: {
			...
			accountLockedResetPassword:
				'Sua conta está bloqueada. Redefina sua senha clicando em "esqueci a senha".',
